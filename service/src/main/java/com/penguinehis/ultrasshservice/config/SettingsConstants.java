...
public interface SettingsConstants
{
	...
	public static final String
		...
		MAXIMO_THREADSPAY_KEY = "numberMaxThreadpayload",
	    //hwid = "",
	   // hwidlock = "",
	...
	public static final String
			...
			CUSTOM_SNI = "sslSNI",
			CUSTOM_PUBKEY = "YubiKey",
			TLS12 = "tls12key",
			XRAY_CONFIG_KEY = "xrayConfig",
			XRAY_UUID_KEY = "xrayUuid"
	...
	public static final int
	    ...
	    bTUNNEL_TYPE_SSH_DNSTT = 4,
	    bTUNNEL_TYPE_SSH_SSL_Proxy = 5,
		bTUNNEL_TYPE_XRAY = 6
	;
}
