...
* @author SlipkHunter
*/
public class SocksReviveCore
{
	private static SocksReviveCore mInstance = null;
	private Context mContext;
	
	public static void init(Context context) {
		if (mInstance == null) {
			mInstance = new SocksReviveCore(context);
		}
	}
	
	private SocksReviveCore(Context context) {
		mContext = context;
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(SocksReviveService.NOTIFICATION_CHANNEL_BG_ID,
        ...
        mChannel = new NotificationChannel(SocksReviveService.NOTIFICATION_CHANNEL_NEWSTATUS_ID,
        ...
        mChannel = new NotificationChannel(SocksReviveService.NOTIFICATION_CHANNEL_USERREQ_ID,
