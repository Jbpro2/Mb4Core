...
public class TunnelVpnService extends VpnService {
  ...
  public void onCreate() {
    ...
    // Make the VpnService instance available immediately so control sockets
    // (SSH / TLS / proxy) can be protected *before* the VPN installs ::/0 and
    // 0.0.0.0/0 routes. Without this, the server connection may get routed into
    // the VPN itself, causing immediate connection resets/reconnect loops.
